...
int main()
{
    ...
    else
    {
            ...
            MDB_head->review.score != 85)
        {
            ...
            //printf(" Str cmp results: %d,%d\t Expected vs Real %d|%d\t %f|%f\t %d,%d",strcmp(MDB_head->review.movie_title, "Alien"),strcmp(MDB_head->review.movie_studio, "20th Century Fox"),1979,MDB_head->review.year,203630630.0,MDB_head->review.BO_total,85,MDB_head->review.score);
            return 1;
        }
